class Medio(object):
	...
	i = 0
        #for oBlanco in blancos # elemento en blancos
        #         una_senal = oBlanco.reflejar(una_senal, tiempo_inicial, tiempo_final) #retorna una lista de señales de cada uno de los bancos q tiene el medio
                  i = i+1
        #retorno una_senal
        pass
